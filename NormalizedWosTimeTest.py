...
before = NormalizedWoSTime.NormalizedWoSTime.CreateNormalizedWoSTime('0', logger)
for testCase in testCases:
    try:
        normalizedTime = NormalizedWoSTime.NormalizedWoSTime.CreateNormalizedWoSTime(testCase, logger)
